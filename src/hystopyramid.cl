...
kernel void make_grid(
    ...
    uint2 coords = convert_uint2(relative / (float)size);
    ...
    atomic_add_float(grid + idx + 3, 1.f);
}
...
kernel void make_level(
    ...
    printf("MKLVL GID=%d:%d LID=%d:%d GR=%d:%d\n",
